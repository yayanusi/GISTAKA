...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('berita.store') }}" autocomplete="off" enctype="multipart/form-data">
                @csrf
                ...
                <div class="pl-lg-4">
                        ...
                        <div class="col">
                            <div class="form-group{{ $errors->has('judul') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="judul" id="input-judul"
                                    ...
                                    placeholder="{{ __('judul') }}" value="{{ old('judul') }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('preview') ? ' has-danger' : '' }}">
                                ...
                                <textarea rows="3" type="preview" name="preview" id="input-preview"
                                    ...
                                    placeholder="{{ __('preview') }}" required>{{ old('preview') }}</textarea>
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="sumber_foto" id="input-sumber_foto"
                                    ...
                                    placeholder="{{ __('masukan sumber foto') }}" value="{{ old('sumber_foto') }}"
                                    required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group{{ $errors->has('isi') ? ' has-danger' : '' }}">
                        ...
                        <textarea id="summernote" name="isi" placeholder="{{ __('isi') }}" required>{{ old('preview') }}</textarea>
